...
Usage: ${script_name} [options]
  ...
  --method=<method to use for susceptibility distortion correction (SDC)>
        ...
        "${PHILIPS_METHOD_OPT}"
             use Philips specific Gradient Echo Field Maps for"
  ...
  Options required if using --method="${PHILIPS_METHOD_OPT}":
    ...
    %TODO [--fmapmag=<input Siemens field map magnitude image>]
    %TODO [--fmapphase=input Siemens field map phase image>]
    %TODO [--echodiff=<difference of echo times for fieldmap, in milliseconds>]
