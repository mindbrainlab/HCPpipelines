...
EchoSpacing=`getopt1 "--echodiff" $@`  # "$4"
...
# -- Convert phase input image to radians

${FSLDIR}/bin/fslmaths ${PhaseInputName} -mul 6.28 ${WD}/FieldMap_rads

# -- Denoise the image (median filtering)

${FSLDIR}/bin/fugue --loadfmap=${WD}/FieldMap_rads -m --savefmap=${WD}/FieldMap_rads_reg

# -- Create brain magnitude image

${FSLDIR}/bin/imcp ${MagnitudeInputName} ${WD}/Magnitude
${FSLDIR}/bin/bet ${WD}/Magnitude ${WD}/Magnitude_brain -f 0.35
...
${FSLDIR}/bin/immv ${WD}/FieldMap_rads_reg ${WD}/FieldMap
${FSLDIR}/bin/imrm ${WD}/FieldMap_rads

# -> magnitude image

${FSLDIR}/bin/imrm ${WD}/Magnitude_brain
${FSLDIR}/bin/immv ${WD}/Magnitude_brain_ero ${WD}/Magnitude_brain

# -> apply gradient field distortion correction if applicable
...
if [ ! $GradientDistortionCoeffs = "NONE" ] ; then
  ...
  ${FSLDIR}/bin/applywarp --rel --interp=spline -i ${WD}/FieldMap -r ${WD}/FieldMap -w ${WD}/Magnitude_gdc_warp -o ${WD}/FieldMap_gdc
